...
import edu.wcu.cs.cs363.team4.project04.gui.shape.Line;
import edu.wcu.cs.cs363.team4.project04.gui.shape.NullShape;
import edu.wcu.cs.cs363.team4.project04.gui.shape.Shape;

/**
 * A producer that is responsible for creating Line shapes. This class
 * also
 * notifies any attached listeners that a Line is being created or has
 * been
 * created.
 * 
...
public class LineProducer extends AbstractTwoPointShapeProducer {
     ...
     * created
     * and then sets the shape to a NullShape.
     * 
     * @param e
    ...
    public void mouseReleased(MouseEvent e) {
        this.line = new Line(getDrawColor(), getStart(), this.end);
        notifyShapeCreated(this.line);
        this.line = NullShape.getNullShape();
    }
     ...
     * and then
     * creates a new Line from the points.
     * 
     * @param e
     *            the MouseEvent that will occur when the mouse is
     *            dragged
    ...
    public void mouseDragged(MouseEvent e) {
        this.end = e.getPoint();
        this.line = new Line(getDrawColor(), getStart(), this.end);
        notifyShapeInProgress(this.line);
    }
}
