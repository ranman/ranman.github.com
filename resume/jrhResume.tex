...
\usepackage{hyperref}
%\definecolor{linkcolor}{HTML}{FF0080} %light purple link for the email
...
\color{text1} % set text color for the whole doc
     \par{\centering{\sffamily\Huge Joseph Randall Hunt}\\
      \color{headings}\fontspec[Variant = 2]{Zapfino} Curriculum  {Vit\fontspec[Variant = 3]{Zapfino}\ae}\\[25pt]\par
      %\color{headings}\fontspec[Variant = 2]{Zapfino}R\'esum\'e\\[20pt]
...
\colorbox{shade}{\textcolor{text1}{
      \begin{tabular}{c|p{4.25cm}r}
         ...
         &\raisebox{2.9pt}{\multirow{2}{*}{\includegraphics[height=1.45cm]{randall}}}\\ 
